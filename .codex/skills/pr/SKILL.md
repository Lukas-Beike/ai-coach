...
3. Poll the PR and its checks in short intervals (about 30 seconds; never block updates for more than 60 seconds). Continue until the PR is merged or a genuine blocker requires the user. For each state:
