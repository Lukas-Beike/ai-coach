...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/api.js?v=188', index)
        self.assertIn('/navigation.js?v=188', index)
        self.assertIn('/state.js?v=188', index)
        self.assertIn('/views.js?v=188', index)
        self.assertIn('/forms.js?v=188', index)
        self.assertIn('/components.js?v=188', index)
        self.assertIn('/app.js?v=188', index)
        self.assertIn('intervals-coach-v188', service_worker)
        self.assertIn('"/navigation.js?v=188"', service_worker)
        self.assertIn('"/state.js?v=188"', service_worker)
        self.assertIn('"/views.js?v=188"', service_worker)
        self.assertIn('"/forms.js?v=188"', service_worker)
        self.assertIn('"/components.js?v=188"', service_worker)
        ...
        self.assertLess(index.index('/forms.js?v=188'), index.index('/components.js?v=188'))
        self.assertLess(index.index('/components.js?v=188'), index.index('/app.js?v=188'))
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/api.js?v=188"', source)
        self.assertIn('"/navigation.js?v=188"', source)
        self.assertIn('"/state.js?v=188"', source)
        self.assertIn('"/views.js?v=188"', source)
        self.assertIn('"/forms.js?v=188"', source)
        self.assertIn('"/components.js?v=188"', source)
        self.assertIn('"/forms.js"', source)
        self.assertIn('"/app.js?v=188"', source)
        self.assertIn('"/icon.svg?v=188"', source)
        self.assertIn('"/styles.css?v=188"', source)
