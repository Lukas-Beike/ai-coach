...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/api.js?v=208', index)
        self.assertIn('/navigation.js?v=208', index)
        self.assertIn('/state.js?v=208', index)
        self.assertIn('/views.js?v=208', index)
        self.assertIn('/forms.js?v=208', index)
        self.assertIn('/components.js?v=208', index)
        self.assertIn('/app.js?v=208', index)
        self.assertIn('intervals-coach-v208', service_worker)
        self.assertIn('"/navigation.js?v=208"', service_worker)
        self.assertIn('"/state.js?v=208"', service_worker)
        self.assertIn('"/views.js?v=208"', service_worker)
        self.assertIn('"/forms.js?v=208"', service_worker)
        self.assertIn('"/components.js?v=208"', service_worker)
        ...
        self.assertLess(index.index('/forms.js?v=208'), index.index('/components.js?v=208'))
        self.assertLess(index.index('/components.js?v=208'), index.index('/app.js?v=208'))
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/api.js?v=208"', source)
        self.assertIn('"/navigation.js?v=208"', source)
        self.assertIn('"/state.js?v=208"', source)
        self.assertIn('"/views.js?v=208"', source)
        self.assertIn('"/forms.js?v=208"', source)
        self.assertIn('"/components.js?v=208"', source)
        self.assertIn('"/forms.js"', source)
        self.assertIn('"/app.js?v=208"', source)
        self.assertIn('"/icon.svg?v=208"', source)
        self.assertIn('"/styles.css?v=208"', source)
