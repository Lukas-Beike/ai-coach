...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/api.js?v=153', index)
        self.assertIn('/navigation.js?v=153', index)
        self.assertIn('/state.js?v=153', index)
        self.assertIn('/views.js?v=153', index)
        self.assertIn('/forms.js?v=153', index)
        self.assertIn('/components.js?v=153', index)
        self.assertIn('/app.js?v=153', index)
        self.assertIn('intervals-coach-v153', service_worker)
        self.assertIn('"/navigation.js?v=153"', service_worker)
        self.assertIn('"/state.js?v=153"', service_worker)
        self.assertIn('"/views.js?v=153"', service_worker)
        self.assertIn('"/forms.js?v=153"', service_worker)
        self.assertIn('"/components.js?v=153"', service_worker)
        ...
        self.assertLess(index.index('/forms.js?v=153'), index.index('/components.js?v=153'))
        self.assertLess(index.index('/components.js?v=153'), index.index('/app.js?v=153'))
    ...
    def test_task8_coach_first_views_have_shared_states_and_analysis_segments(self):
        ...
        self.assertIn('analysisSegment: "history"', state)
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/api.js?v=153"', source)
        self.assertIn('"/navigation.js?v=153"', source)
        self.assertIn('"/state.js?v=153"', source)
        self.assertIn('"/views.js?v=153"', source)
        self.assertIn('"/forms.js?v=153"', source)
        self.assertIn('"/components.js?v=153"', source)
        self.assertIn('"/forms.js"', source)
        self.assertIn('"/app.js?v=153"', source)
        self.assertIn('"/icon.svg?v=153"', source)
        self.assertIn('"/styles.css?v=153"', source)
    ...
    def test_bulk_library_ui_has_scoped_selection_and_versioned_assets(self):
        ...
        self.assertIn("intervals-coach-v153", worker)
        self.assertIn("/app.js?v=153", index)
