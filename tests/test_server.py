...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/api.js?v=131', index)
        self.assertIn('/navigation.js?v=131', index)
        self.assertIn('/state.js?v=131', index)
        self.assertIn('/app.js?v=131', index)
        self.assertIn('intervals-coach-v131', service_worker)
        self.assertIn('"/navigation.js?v=131"', service_worker)
        self.assertIn('"/state.js?v=131"', service_worker)
    ...
    def test_versioned_static_assets_are_immutable_and_support_etag_revalidation(self):
        ...
        first = make_handler("/state.js?v=131")
        server.RequestHandler.send_static(first, "/state.js")
        ...
        cached = make_handler("/state.js?v=131", {"If-None-Match": response_headers["ETag"]})
        server.RequestHandler.send_static(cached, "/state.js")
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/api.js?v=131"', source)
        self.assertIn('"/navigation.js?v=131"', source)
        self.assertIn('"/state.js?v=131"', source)
        self.assertIn('"/app.js?v=131"', source)
        self.assertIn('"/icon.svg?v=131"', source)
