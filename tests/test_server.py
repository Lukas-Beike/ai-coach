...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/api.js?v=132', index)
        self.assertIn('/navigation.js?v=132', index)
        self.assertIn('/state.js?v=132', index)
        self.assertIn('/views.js?v=132', index)
        self.assertIn('/app.js?v=132', index)
        self.assertIn('intervals-coach-v132', service_worker)
        self.assertIn('"/navigation.js?v=132"', service_worker)
        self.assertIn('"/state.js?v=132"', service_worker)
        self.assertIn('"/views.js?v=132"', service_worker)
    ...
    def test_versioned_static_assets_are_immutable_and_support_etag_revalidation(self):
        ...
        first = make_handler("/views.js?v=132")
        ...
        cached = make_handler("/views.js?v=132", {"If-None-Match": response_headers["ETag"]})
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/api.js?v=132"', source)
        self.assertIn('"/navigation.js?v=132"', source)
        self.assertIn('"/state.js?v=132"', source)
        self.assertIn('"/views.js?v=132"', source)
        self.assertIn('"/app.js?v=132"', source)
        self.assertIn('"/icon.svg?v=132"', source)
