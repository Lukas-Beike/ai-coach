...
class CoachTests(unittest.TestCase):
    ...
    def test_maintenance_ui_status_and_restore_asset_versions_are_present(self):
        ...
        self.assertIn('/app.js?v=217', index)
        self.assertIn('intervals-coach-v217', service_worker)
        ...
        self.assertLess(index.index('/components.js?v=217'), index.index('/app.js?v=217'))
    ...
    def test_service_worker_caches_only_versioned_static_assets_and_not_api(self):
        ...
        self.assertIn('"/app.js?v=217"', source)
