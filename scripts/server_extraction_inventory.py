...
def _explicit_owner(name: str) -> str | None:
    explicit = {
            ...
            "_gemini_content_has_function_response": PROVIDERS_PACKAGE,
            "_gemini_history_exchange_boundary": PROVIDERS_PACKAGE,
            "_trim_gemini_history": PROVIDERS_PACKAGE,
            "_gemini_history_parts_without_raw_media": PROVIDERS_PACKAGE,
