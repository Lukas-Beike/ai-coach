...
def _explicit_owner(name: str) -> str | None:
    explicit = {
            ...
            "ATHLETE_RECORD_HANDLERS": "coach/tool_execution.py",
            "DB_LOCK": DB_MANAGER,
            "DATABASE_MANAGER": DB_MANAGER,
            ...
            "PERFORMANCE_LOCK": "sync/performance.py",
            ...
            "_prepare_structured_plan_sync": "coach/tool_execution.py",
            ...
            "check_adaptive_replan": "sync/adaptive.py",
            "_adaptive_replan_result": "sync/adaptive.py",
            "apply_adaptive_replan": "sync/adaptive.py",
            ...
            "_performance_refresh_failed": "sync/performance.py",
            "_performance_refresh_poll_state": "sync/performance.py",
            ...
            "_delete_competition_tombstones": "sync/competitions.py",
            "_competition_remote_events": "sync/competitions.py",
            "_competition_sync_records": "sync/competitions.py",
            "_competition_sync_remote_indexes": "sync/competitions.py",
            "_competition_sync_remote_match": "sync/competitions.py",
            "_record_competition_sync_conflict": "sync/competitions.py",
            "_remote_missing_competition_conflict": "sync/competitions.py",
            "_reconcile_dirty_competition": "sync/competitions.py",
            "_reconcile_synced_competition": "sync/competitions.py",
            "_remote_competition_local_id": "sync/competitions.py",
            "_suppressed_competition_identifiers": "sync/competitions.py",
            "_import_remote_competitions": "sync/competitions.py",
            "_preserved_dirty_library_workout": "sync/library.py",
            "_preserve_remote_library_metadata": "sync/library.py",
            "_persist_remote_library_workout_entry": "sync/library.py",
            "_mark_missing_remote_library_workouts": "sync/library.py",
            "upsert_workout_library": "sync/library.py",
            "LIBRARY_PAGE_MAX": "http_api/pagination.py",
            "update_planned_unit_sync_state": "sync/planned_units.py",
            "_planned_unit_sync_guard": "sync/planned_units.py",
            "_workout_library_sync_rows": "sync/library.py",
            "_workout_library_sync_category": "sync/library.py",
            "_workout_library_sync_entry": "sync/library.py",
            "_workout_library_sync_snapshot": "sync/library.py",
            "refresh_workout_library": "sync/library.py",
            "plan_library_workout_remote": "sync/library.py",
            "update_workout_library_sync_state": "sync/library.py",
            "workout_library_sync_summary": "sync/library.py",
            "_load_local_library_workout_for_sync": "sync/library.py",
            "_upsert_remote_library_workout": "sync/library.py",
            "_store_library_workout_remote_identity": "sync/library.py",
            "_finish_library_workout_sync": "sync/library.py",
            "_selected_library_sync_row": "sync/library.py",
            "_library_sync_error": "sync/library.py",
            "_verify_selected_library_repair": "sync/library.py",
            "_update_remote_planned_conflict": "sync/planned_units.py",
            "_update_remote_planned_clean": "sync/planned_units.py",
            "_upsert_remote_planned_event": "sync/planned_units.py",
            "_mark_missing_remote_planned_units": "sync/planned_units.py",
            "upsert_remote_planned_units": "sync/planned_units.py",
            "_seed_intervals_workout_library": "sync/library.py",
            "_enqueue_coach_plan_push": "sync/planned_units.py",
            ...
            "refresh_current_performance": "sync/performance.py",
            ...
            "_coach_session_key": COACH_JOBS,
            "_restore_coach_session_csrf_hash": COACH_JOBS,
            "_coach_command_receipt": "coach/service.py",
            "_merge_coach_command_receipt": "coach/service.py",
            "_chat_provider_settings": "coach/service.py",
            "_resume_background_chat_command": "coach/service.py",
            "chat_with_coach": "coach/service.py",
            ...
            "STRUCTURED_READ_ONLY_TOOLS": "coach/authorization.py",
            "coach_execution_scope": "coach/authorization.py",
            "_coach_scope_values": "coach/authorization.py",
            "_require_coach_scope": "coach/authorization.py",
            "_stage_coach_artifact": "coach/artifacts.py",
            "_sync_structured_training_plan": "coach/tool_execution.py",
            "_structured_coach_read_result": "coach/tool_execution.py",
            "_queue_structured_performance_refresh": "coach/tool_execution.py",
            "TRAINING_PLAN_SCOPE_PREFIX": "coach/authorization.py",
            ...
            "_replace_structured_coach_training_plan": "coach/tool_execution.py",
            "_validate_structured_training_change_scopes": "coach/tool_execution.py",
            "_apply_structured_adaptive_replan": "coach/tool_execution.py",
            "_append_planning_command_scope": "coach/tool_execution.py",
            "ILLNESS_CALENDAR_CATEGORY": "sync/adaptive.py",
            "ILLNESS_EVENT_EXTERNAL_PREFIX": "sync/adaptive.py",
            "PLANNED_CALENDAR_HISTORY_DAYS": "sync/planned_units.py",
            "PLANNED_CALENDAR_FUTURE_DAYS": "sync/planned_units.py",
            ...
            "coach_dialogue_context": "coach/service.py",
            "_apply_dialogue_operation_scope": "coach/service.py",
            "_save_coach_question": "coach/service.py",
            "_matching_coach_steps_repaired": "coach/service.py",
            "_coach_steps_repaired": "coach/service.py",
            "_unresolved_coach_steps": "coach/service.py",
            "_coach_repair_key": "coach/service.py",
            "_append_template_command_scope": "coach/service.py",
            "_add_structured_coach_attachment_evidence": "coach/service.py",
            ...
            "_send_structured_coach_response": "coach/service.py",
            "_recover_structured_coach_conversation": "coach/service.py",
            "_resume_background_coach_response": "coach/service.py",
            "_recover_invalid_structured_conversation": "coach/service.py",
            "_wait_for_coach_response_retry": "coach/service.py",
            "_StructuredCoachResponseAttemptContext": "coach/service.py",
            "_mark_resolved_coach_receipts": "coach/service.py",
            "_coach_effects": "coach/service.py",
            "_persist_structured_coach_pending_request": "coach/service.py",
            "_structured_tool_call_metadata": "coach/tool_execution.py",
            "_cached_structured_tool_call": "coach/tool_execution.py",
            "_prepare_structured_tool_execution": "coach/tool_execution.py",
            "_structured_tool_call_failure": "coach/tool_execution.py",
            "_StructuredCoachRoundState": "coach/tool_execution.py",
            "_record_structured_coach_tool_output": "coach/tool_execution.py",
            "_run_structured_coach_tool_rounds": "coach/tool_execution.py",
            "_persist_structured_coach_final_receipt": "coach/service.py",
            "_chat_with_structured_coach_impl": "coach/service.py",
            "current_coach_proposals": "coach/proposals.py",
            "prune_expired_coach_proposals": "coach/proposals.py",
            "coach_command_receipt": "coach/service.py",
            "_chat_with_structured_coach": "coach/service.py",
            "coach_dialogue_artifact_refs": "coach/context.py",
            "chat_stream_status": "coach/streams.py",
            "_validated_chat_request": "coach/service.py",
            "_recover_stale_chat_command": "coach/service.py",
            "_chat_command_state": "coach/service.py",
            ...
            "_execute_coach_action": "coach/tool_execution.py",
            "_existing_background_coach_job_response": COACH_JOBS,
            "enqueue_background_coach_job": COACH_JOBS,
            "_execute_claimed_planning_command": "coach/tool_execution.py",
            "_execute_structured_coach_tool": "coach/tool_execution.py",
            "_execute_structured_coach_tool_call": "coach/tool_execution.py",
