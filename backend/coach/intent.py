...
def intent_request_payload(
    ...
    return {
        ...
        "instructions": (
            ...
            "intervals_sync scope, and keep artifact_id null because the stage operation creates a new artifact. "
            ...
            "Merely mentioning a completed session as context for a future plan does not request a separate "
            "feedback write. For example, 'I completed upper-body strength today; plan the next two weeks' "
            "authorizes stage_training_plan and commit_training_plan only. "
